<template>
  <div class="hello">
    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        <router-link :to="{name: 'Bookmark', params: {user: this.user}}" class="nav-link">Bookmark</router-link>
      </li>
      <li class="nav-item">
        <router-link :to="{name: 'Profile', params: {user: this.user}}" class="nav-link">Profile</router-link>
      </li>
      <li class="nav-item">
